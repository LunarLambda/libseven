...
enum WaitstateFlags
{
    WS_SRAM_WAIT_4              = BITFIELD(0, 0),
    WS_SRAM_WAIT_3              = BITFIELD(0, 1),
    WS_SRAM_WAIT_2              = BITFIELD(0, 2),
    WS_SRAM_WAIT_8              = BITFIELD(0, 3),

    WS_ROM_N_WAIT_4             = BITFIELD(2, 0),
    WS_ROM_N_WAIT_3             = BITFIELD(2, 1),
    WS_ROM_N_WAIT_2             = BITFIELD(2, 2),
    WS_ROM_N_WAIT_8             = BITFIELD(2, 3),

    WS_ROM_S_WAIT_2             = BITFIELD(4, 0),
    WS_ROM_S_WAIT_1             = BITFIELD(4, 1),

    WS_PHI_OFF                  = BITFIELD(11, 0),
    WS_PHI_4MHZ                 = BITFIELD(11, 1),
    WS_PHI_8MHZ                 = BITFIELD(11, 2),
    WS_PHI_16MHZ                = BITFIELD(12, 3),
