...
#define REG_DMA0SRC     VOLADDR(0x040000B0, u32)
#define REG_DMA0DST     VOLADDR(0x040000B4, u32)
...
#define REG_DMA1SRC     VOLADDR(0x040000BC, u32)
#define REG_DMA1DST     VOLADDR(0x040000C0, u32)
...
#define REG_DMA2SRC     VOLADDR(0x040000C8, u32)
#define REG_DMA2DST     VOLADDR(0x040000CC, u32)
...
#define REG_DMA3SRC     VOLADDR(0x040000D4, u32)
#define REG_DMA3DST     VOLADDR(0x040000D8, u32)
